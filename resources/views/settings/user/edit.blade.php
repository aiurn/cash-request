...
<div class="row">
    <div class="col-lg-6 col-md-12 col-sm-12">
        ...
        <div class="card">
            <form action="{{ route('settings.user.update', $user->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('patch')
                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="name" id="" class="form-control @error('name') is-invalid @enderror" placeholder="Input Full Name" value="{{ $user->name }}">
                        @error('name')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="username" id="" class="form-control @error('username') is-invalid @enderror"placeholder="Input Username" value="{{ $user->username }}">
                        @error('username')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="email" name="email" id="" class="form-control @error('email') is-invalid @enderror" placeholder="Input Email Address" value="{{ $user->email }}">
                        @error('email')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>

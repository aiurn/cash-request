                    ...
                    <div class="table-responsive">
                        <table id="cash-request-detail-table" class="table table-striped table-borderless table-hovered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="text" class="form-control description" name="description[]" value="{{ $item->description }}"></td>
                                    <td><input type="text" class="form-control unit" name="unit[]" value="{{ $item->unit }}"></td>

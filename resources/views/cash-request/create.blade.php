...
<div class="row">
    <div class="col-lg-6 col-md-12 col-sm-12">
        ...
        <div class="card">
            <form action="{{ route('cash-request.store') }}" method="post">
                @csrf
                <div class="card-header">
                    <h4 class="fw-bold">
                        <i class="fas fa-building"></i> Create Cash Request
                    </h4>
                </div>
                <div class="card-body">
                    <div class="form-group mb-3">
                        <label for="" class="form-label">Date</label>
                        <input type="date" class="form-control @error('datetime') is-invalid @enderror" name="date">
                        @error('datetime')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="project_id" class="form-select @error('project') @enderror">
            ...
            <div class="card-header">
                <div class="d-flex">
                    ...
                    <div class="p-2 bd-highlight">
                        <a href="{{ route('cash-request-detail.store') }}" class="btn btn-primary"><i class="fas fa-plus"></i> New Data</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
